...
DoOrExit CREATE CreatePartition 1 147456 ${LINUX_FS_TYPE} ${ROOT_SKIP} ${DISKNODE}
DoOrExit CREATE CreatePartition 2 151552 ${LINUX_FS_TYPE} ${ROOT_SKIP} ${DISKNODE}
DoOrExit CREATE CreatePartition 3 8087552 ${LINUX_FS_TYPE} ${ROOT_SKIP} ${DISKNODE}

dd if=/dev/synoboot1 of=/dev/sda1
dd if=/dev/synoboot2 of=/dev/sda2
dd if=/dev/synoboot3 of=/dev/sda3 status=progress bs=8M
